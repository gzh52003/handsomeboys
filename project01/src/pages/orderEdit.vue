      ...
      <el-col :span="16">
        ...
        >
          ...
          <el-form-item label="总价">
            <el-input type="text" v-model.number:total="ruleForm.num*ruleForm.price" autocomplete="off"></el-input>
          </el-form-item>
          ...
          <el-form-item label="联系方式">
            <el-input type="text" v-model="ruleForm.contact" autocomplete="off"></el-input>
          </el-form-item>
    ...
    submitForm() {
      this.$refs["ruleForm"].validate(async (valid) => {
        if (valid) {
          ...
          const { data } = await this.$request.put("/order/" + userid, {
            ...ruleForm,
          });
          //请求所有用户个人信息
